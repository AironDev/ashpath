...
class EscrowController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if (!$request->isMethod('post'))
        {
            ...
            return view('user_dashboard.escrow.create', $data);
        }
        else if ($request->isMethod('post'))
        {
            ...
            return view('user_dashboard.escrow.confirmation', $data);
        }
    }
    ...
    public function sendMoneyConfirm(Request $request)
    {
        ...
        session()->forget('transInfo');
        clearActionSession();
        return view('user_dashboard.escrow.success', $data);
    }
