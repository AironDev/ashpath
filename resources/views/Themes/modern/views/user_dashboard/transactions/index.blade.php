                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="pr-3 mt-2">
                                    <select class="form-control w-200p" id="type" name="type">
                                        ...
                                        <option value="{{Escrow}}" <?= ($type == Escrow) ? 'selected' : '' ?>>
                                            @lang('Escrow')
                                        </option>
                                                                    ...
                                                                    <div class="modal-body p-0">
                                                                        ...
                                                                        <div class="row activity-details" id="loader_{{$transaction->id}}"
                                                                            ...
                                                                            <div class="col-md-5 bg-primary">
                                                                                    ...
                                                                                    <!-- <div class="form-group text-center"><a href="http://paymoney.test/moneytransfer/print/60" target="_blank" class="btn btn-light pl-4 pr-4 btn-sm">Release</a> &nbsp;&nbsp;</div> -->
                                                                            </div>
                                                                                ...
                                                                                <div class="col-md-12 col-sm-12">
                                                                                    <div class="text-center mb-4">
                                                                                        ...
                                                                                        @endif
                                                                                         ...
                                                                                         @if( $transaction->status == 'Success' && !isset($transaction->dispute->id))
                                                                                            <a id="dispute_{{$transaction->id}}" href="{{url('/dispute/add/').'/'.$transaction->id}}" class="btn btn-grad btn-sm">@lang('message.dashboard.transaction.open-dispute')</a>
